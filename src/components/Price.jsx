                ...
                {pricingOptions.map((option, index) => (
                    <div key={index} className="w-full sm:w-1/2 lg:w-1/3 p-2">
                        <div className="p-10 border border-neutral-700 rounded-xl">
                            ...
                            <p className="mb-8">
                                <span className="text-3xl lg:text-5xl">{option.price}</span>
                            ...
                            <a href="#" className="inline-flex justify-center items-center text-center w-full h-12 p-5 mt-20 tracking-tight text-xl border border-orange-900 rounded-lg transition duration-200 hover:bg-orange-900 "> Subscribe</a>
                        </div>
                    </div>
                ))}
            </div>
