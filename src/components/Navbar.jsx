                ...
                {mobileDrawerOpen && (
                    <div className="fixed right-0 z-20 bg-neutral-900 w-full p-12 flex flex-col justify-center  lg:hidden">
                        ...
                        <div className="flex  flex-col sm:flex-row md:flex-row gap-4">
                            <a href="#" className="py-2 px-3 border rounded-md text-center "> Sign In</a>
                            <a href="#" className="py-2 px-3 rounded-md bg-gradient-to-r from-orange-500 to-orange-800 text-center">Create an account</a>
                        </div>
                    </div>
                )}
            </div>
